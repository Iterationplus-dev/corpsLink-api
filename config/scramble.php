...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'CorpsLink REST API — campus transport booking for NYSC corps members. All authenticated endpoints use a Sanctum bearer token obtained from /api/v1/auth/login or /api/v1/auth/register/complete.',
    ],
